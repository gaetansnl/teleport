...
const (
	...
	// eventTypeDocProperty is the event struct tag associated with EventType.
...
func (l *Log) ensureIndexes(adminSvc *apiv1.FirestoreAdminClient) error {
	indexes := []firestorebk.CompositeIndex{
		{
			{Field: eventNamespaceDocProperty, Order: admin.Index_IndexField_ASCENDING},
			{Field: createdAtDocProperty, Order: admin.Index_IndexField_ASCENDING},
		},
		{
			{Field: eventNamespaceDocProperty, Order: admin.Index_IndexField_ASCENDING},
			{Field: createdAtDocProperty, Order: admin.Index_IndexField_DESCENDING},
		},
		{
			{Field: eventNamespaceDocProperty, Order: admin.Index_IndexField_ASCENDING},
			{Field: eventTypeDocProperty, Order: admin.Index_IndexField_ASCENDING},
			{Field: createdAtDocProperty, Order: admin.Index_IndexField_ASCENDING},
		},
		{
			{Field: eventNamespaceDocProperty, Order: admin.Index_IndexField_ASCENDING},
		...
		{
			{Field: sessionIDDocProperty, Order: admin.Index_IndexField_ASCENDING},
			{Field: eventIndexDocProperty, Order: admin.Index_IndexField_ASCENDING},
		},
	}
	err := firestorebk.EnsureIndexes(l.svcContext, adminSvc, indexes, l.getIndexParent())
	return trace.Wrap(err)
}
